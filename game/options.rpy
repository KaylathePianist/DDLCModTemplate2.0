define config.name = "DDLC Minimal Mod Template"
define gui.show_name = True
define config.version = "1.0"
define gui.about = _("")

define build.name = "DDLCMinimalTemplate"
...
define config.save_directory = "MinimalDDLCTemplate"
...
init python:
    ...
    build.package("Renpy8-DDLCMod", 'zip', 'windows linux mac renpy mod all',
